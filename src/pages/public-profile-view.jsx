            ...
            <div className="dashboard-main">
                <div className="dashboard-page-header">
                    <div>
                        ...
                        <p>Review what hiring teams see, control visibility, and keep your showcase links updated.</p>
                    </div>
                    ...
                    <div className="d-flex flex-wrap gap-2">
                        ...
                        <a href="#" className="btn btn-primary">
                            <i className="fa-solid fa-eye" aria-hidden="true"></i> View live profile
                        </a>
                    </div>
                </div>
                ...
                <div className="dashboard-cover-card mb-4">
                    ...
                    <div className="dashboard-cover-profile">
                        ...
                        <div>
                            <h3>Job Seeker</h3>
                            <p>Lead Product Designer · Remote friendly · Currently shipping
                    ...
                    <ul>
                        <li>
                            ...
                            <label className="toggle-switch">
                                <input type="checkbox" checked={recruiterSearch} onChange={() => setRecruiterSearch(!recruiterSearch)} />
                        ...
                        <li>
                            ...
                            <label className="toggle-switch">
                                <input type="checkbox" checked={searchIndexing} onChange={() => setSearchIndexing(!searchIndexing)} />
                                <span className="toggle-slider"></span>
                            </label>
                        </li>
                    </ul>
                ...
                <div className="list-card mt-4">
                    ...
                    <ul>
                        <li>
                            ...
                            <a href="/edit-profile" className="btn btn-outline-primary btn-sm rounded-3">
                                Edit
                            </a>
                        </li>
