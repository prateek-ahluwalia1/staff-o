...
export default function NotificationAcceptModal({
    ...
    return (
        <>
            ...
            <div className="modal-overlay" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="accept-title">
                <div className="modal-content-light" onClick={(e) => e.stopPropagation()}>
                    <div className="modal-header-green">
                        <h3 id="accept-title" style={{ margin: 0, fontSize: "20px", fontWeight: 700 }}>
                    ...
                    <div className="modal-footer-light">
                        <button type="button" className="btn-outline-secondary-light" onClick={onClose}>
                            Close
                        </button>
                        <button
                            type="button"
