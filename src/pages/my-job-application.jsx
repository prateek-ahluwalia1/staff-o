  ...
  return (
    <>
      <style>
        {`
          ...
          @media (max-width: 575.98px) {
            ...
            .header-date-group .react-datepicker-wrapper {
              width: 100%;
              margin-bottom: 8px;
            }
          ...
          .header-date-group .react-datepicker__input-container input {
            width: 100%;
            border: none;
          ...
          .header-date-group .react-datepicker__input-container input:focus {
            outline: none;
            box-shadow: none;
          }
        `}
      ...
      <div className="dashboard-main">
        <div className="dashboard-page-header d-flex flex-column flex-xl-row justify-content-between align-items-start align-items-xl-center">
          <div>
          ...
          <div className="d-flex flex-column flex-md-row gap-3 mt-3 mt-xl-0 align-items-md-center header-filters-row">
            <div
              className="d-flex align-items-center bg-white p-1 px-2 rounded shadow-sm border"
          ...
          {filteredApplications.length === 0 ? (
            ...
            filteredApplications.map((app, index) => (
              <div className="col" key={app.id || index}>
                <div
                  className="card h-100 border-0 shadow-sm shift-card-hover"
                      ...
                      >
                        <div className="d-flex flex-column">
                          ...
                          <span
                            ...
                            style={{ fontSize: "13px" }}
                          >
                            <i className="fa-regular fa-user me-1 text-primary opacity-75"></i>{" "}
                            {app.appliedVia}
                          </span>
                          <span
