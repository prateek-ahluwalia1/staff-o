...
export default function Home() {
    ...
    const steps = [
        ...
        },
        {
            ...
            description: 'Apply to your preferred jobs or hire top talent effortlessly.',
        },
    ];
    ...
    const blogPosts = [
        {
            ...
            excerpt: 'From first touch to offer, here’s the messaging stack and automation playbook we use to keep talent engaged.',
        ...
        },
        {
            ...
            excerpt: 'Weekly dashboards, async standups, and lightweight rituals that keep strategic bets on track.',
        ...
        },
        {
            ...
            excerpt: 'A look at how we bundle product education, values training, and buddy systems into a cohesive journey.',
    ...
    return (
        ...
        <style>{`
                ...
                <div className="container">
                    <div className="titleTop text-center">
                        ...
                        <div className="category-carousel-wrap position-relative">
                            ...
                            <Swiper modules={[Navigation]} spaceBetween={20} slidesPerView={1}
                                navigation={{
                                ...
                                <SwiperSlide key={index}>
                                    <div className="category-card text-center">
                                        <div className="category-icon mb-3">
                                            <img src={`/assets/images/categories/${cat.icon}`} alt={cat.title} />
                                        </div>
                                ...
                                <div className="job-card">
                                    ...
                                    <div className="job-card-footer">
                                        ...
                                        <div className="job-card-logo">
                                            <img src={`/assets/images/employers/${job.logo}`} alt={job.company} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6">
                            <div className="video-content-v2">
                                ...
                                <ul className="video-features-v2">
                                    <li>
                                        <i className="fa fa-check-circle" aria-hidden="true"></i> Learn about our platform
                                    </li>
                                    <li>
                                        <i className="fa fa-check-circle" aria-hidden="true"></i> Discover success stories
                                    </li>
                                    <li>
                                        <i className="fa fa-check-circle" aria-hidden="true"></i> See how it works
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6">
                            <div className="video-wrapper-v2">
                                <div className="video-thumbnail-v2">
                                    <img src="/assets/images/video-thumbnail.jpg" alt="Video thumbnail" className="video-image-v2"/>
                                    <div className="video-overlay-v2"></div>

                                    {/* Play button - opens modal */}
                                    <button className="video-play-btn-v2" type="button" data-bs-toggle="modal"
            ...
            {/* Video Modal */}
            <div className="modal fade" id="videoModalV2" tabIndex="-1" aria-labelledby="videoModalV2Label" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered modal-lg">
                    <div className="modal-content video-modal-content-v2">
                        <button type="button" className="btn-close video-modal-close-v2" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <div className="latest-job-card">
                                    ...
                                    <div className="latest-job-footer">
                                        <div className="latest-job-company">
                                            <img src={`/assets/images/employers/${job.logo}`} alt="Company logo" />
                                            <div>
            ...
            <section className="section testimonials-section">
                <div className="container">
                    ...
                    <div className="testimonials-wrap position-relative">
                        ...
                        <Swiper modules={[Navigation]} spaceBetween={30} slidesPerView={1}
                            navigation={{
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-6">
                            ...
                            <div className="appimg">
                                <img src="/assets/images/app-screens.png" alt="JobsPortal App Screens" />
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-6">
                            ...
                            <div className="subtitle2">A world of oppertunity in your hand</div>
                            ...
                            <div className="appbtn">
                                <a href="#">
                                    <img src="/assets/images/apple-btn.png" alt="Download on App Store" />
                                </a>
                                <a href="#">
                                    <img src="/assets/images/andriod-btn.png" alt="Get it on Google Play" />
                                </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="blog-card-body">
                                        ...
                                        <div className="blog-card-footer">
                                            <div className="author">
                                                <img src={`/assets/images/${post.authorImage}`} alt="Author" />
                                            <div>
