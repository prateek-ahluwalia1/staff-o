    ...
    <section className="nh-section">
      <div className="nh-wrap">
        <div className="nh-section-head">
          ...
          <h2>From posted job to filled shift</h2>
        </div>
        <div className="nh-steps">
          <div className="nh-step">
            <div className="nh-step-num">01</div>
            <h3>Post the job</h3>
            <p>Tell us the location, shift time and licence type you need.</p>
          </div>
          <div className="nh-step">
          ...
          <div className="nh-step">
            ...
            <h3>Confirm &amp; brief</h3>
            <p>Message directly, share site details, lock in the shift.</p>
          </div>
          <div className="nh-step">
