  ...
  return (
    <section className="stf-section stf-band">
      <div className="stf-wrap">
        ...
        <div className="mjs-grid">
          <div style={{ border: "1.5px solid var(--border)", borderRadius: "var(--radius)", padding: "20px 22px", background: "var(--white)", display: "flex", flexDirection: "column", gap: "14px", alignItems: "start" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "13.5px", color: "var(--text-secondary)" }}>Change the rate, hours or details on any position that has not been booked yet. Security staff already booked keep the terms they accepted.</p>
            </div>
          </div>
          <div style={{ border: "1.5px solid var(--border)", borderRadius: "var(--radius)", padding: "20px 22px", background: "var(--white)", display: "flex", flexDirection: "column", gap: "14px", alignItems: "start" }}>
            <div style={{ width: "34px", height: "34px", borderRadius: "9px", background: "var(--green-light)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "13.5px", color: "var(--text-secondary)" }}>Pushes a notification to every eligible security staff in the area straight away. Useful when someone drops out or a site need appears overnight.</p>
            </div>
          </div>
          <div style={{ border: "1.5px solid var(--border)", borderRadius: "var(--radius)", padding: "20px 22px", background: "var(--white)", display: "flex", flexDirection: "column", gap: "14px", alignItems: "start" }}>
            <div style={{ width: "34px", height: "34px", borderRadius: "9px", background: "var(--green-light)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          ...
          <div style={{ border: "1.5px solid var(--border)", borderRadius: "var(--radius)", padding: "20px 22px", background: "var(--white)", display: "flex", flexDirection: "column", gap: "14px", alignItems: "start" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "13.5px", color: "var(--text-secondary)" }}>Unfilled positions can be cancelled at any time at no cost. If security staff is already booked, cancel as early as you can so they can find other work.</p>
            </div>
          </div>
        </div>
      </div>
