...
function Testamonial() {
  ...
  <div className="test-grid">
    <div className="test-card reveal">
      ...
      <p className="test-quote">Staffoo made hiring security staff effortless. Within hours we had verified professionals for our event. I can trust the quality of the staff every single time.</p>
    ...
    <div className="test-card reveal reveal-d1">
      ...
      <p className="test-quote">Posting jobs on Staffoo is straightforward and the staff profiles are thorough. We've filled multiple positions without any hassle. Highly recommended platform.</p>
      <div className="test-author">
    ...
    <div className="test-card reveal reveal-d2">
      ...
      <p className="test-quote">The Resource Partner dashboard is a lifesaver. Assigning jobs and monitoring progress is seamless and I always know our security needs are met by qualified staff.</p>
      <div className="test-author">
