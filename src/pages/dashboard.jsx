            ...
            <div className="dashboard-main">
                ...
                <div className="dashboard-cover-card">
                    <div className="dashboard-cover-media">
                        <img src="/assets/images/user-cover.jpg" alt="Workspace collaboration" />
                    </div>
                    <div className="dashboard-cover-profile">
                        ...
                        <div>
                            ...
                            <ul>
                                <li><i className="fa-solid fa-phone"></i> +1 234 567 890</li>
                                <li><i className="fa-solid fa-envelope"></i> seeker@jobsportal.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <section className="dashboard-panel">
                    ...
                    <div className="package-grid">
                        {packageDetails.map((item, index) => (
                            <div key={index} className={`package-chip ${item.isDanger ? 'danger' : ''}`}>
