        ...
        <>
            ...
            <div className="dashboard-main p-4">
                <div className="dashboard-page-header mb-4 d-flex justify-content-between align-items-center">
                    <div>
                        <h1 className="fw-bold mb-1">Available Cover Jobs</h1>
                        <p className="text-muted mb-0">
                            Showing {visibleJobs.length} of {totalJobs - removedJobIds.length} available shifts
                        </p>
                    </div>
                </div>
                                            ...
                                            <div className="mt-auto">
                                                <div className="d-flex align-items-center mb-4 p-3 rounded-3" style={{ backgroundColor: "#f8fafc", border: "1px solid #f1f5f9" }}>
                                                    ...
                                                    <div className="d-flex flex-column">
                                                        ...
                                                        <span className="text-muted" style={{ fontSize: "12px" }}>
                                                            To: {formatDateTime(job.end_time)}
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="d-flex justify-content-between align-items-center pt-3 border-top" style={{ borderColor: "#f8f9fa" }}>
                                                    <div className="d-flex flex-column">
                                                        ...
                                                        <span className="fw-bold text-dark" style={{ fontSize: "13px", textTransform: 'capitalize' }}>{job.state}</span>
                                                    </div>
                                ...
                                <div className="col-md-6">
                                    <div className="p-4 bg-white rounded-4 h-100 shadow-sm border border-light">
                                        ...
                                        <div className="d-flex flex-column gap-1">
                                            <InfoRow icon="fa-signature" label="Site Name" value={selectedJob.site_name} />
                                            <InfoRow icon="fa-map-pin" label="Address" value={selectedJob.site_address} transform={false} />
