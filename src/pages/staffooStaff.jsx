...
const StaffooStaff = () => {
    ...
    const {
        ...
        error,
        refetch,
    } = useFetch(`api/get-contractor-staff/1`, {
        isAuth: true,
    });
      ...
      `}</style>
            ...
            <div className="staff-hero">
                <span className="staff-hero-eyebrow">
                    <span className="dot"></span> Staffoo
                </span>
            ...
            <div className="content-card p-3">
                <div className="d-flex justify-content-between align-items-center gap-3 flex-wrap">
                    <div className="d-flex align-items-center gap-3">
                        <div style={{ width: "36px", height: "36px", background: "rgba(10,124,110,0.08)", color: "#0A7C6E", borderRadius: "10px" }} className="d-flex align-items-center justify-content-center">
                ...
                <div className="full-screen-modal" style={{
                    ...
                    <div className="modal-inner-content" style={{
                        ...
                        <div className="flex-grow-1 overflow-auto px-4 py-4"
                            onScroll={() => {
                                if (document.activeElement?.id === "address") document.activeElement.blur();
                            }}
                        >
                            <div className="modal-tabs-container mb-4" style={{ background: "#f3f4f6", padding: "4px", borderRadius: "12px", display: "inline-flex", flexWrap: "wrap", gap: "4px" }}>
                                ...
                                {editingUser && (
                                    <>
                                        ...
                                        <button
                                            type="button"
                                            className={`btn ${activeModalTab === "onboarding" ? "btn-dark" : "btn-light"} border-0`}
                                ...
                                <div className="input-group position-relative shadow-sm rounded-3 overflow-hidden">
                                    <button
                                        ...
                                        onClick={(e) => {
                                            ...
                                            if (picker) { try { picker.showPicker(); } catch (err) { picker.focus(); } }
                                        }}
            ...
            {isDeleteModalOpen && (
                <div className="confirm-modal-backdrop" onClick={closeDeleteModal}>
                    <div className="confirm-modal-card" onClick={(e) => e.stopPropagation()}>
                        <div className="confirm-modal-header px-4 py-3 d-flex align-items-center gap-3">
                            <span className="confirm-modal-icon" style={{ background: "#fee2e2", color: "#dc2626" }}>
