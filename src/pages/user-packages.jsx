            ...
            <div className="dashboard-main">
                <div className="dashboard-page-header">
                    <div>
                        ...
                        <p>Unlock more visibility, AI tools, and concierge support with the plan that fits your search.</p>
                    </div>
                    ...
                    <div className="d-flex flex-wrap gap-2">
                        ...
                        <a href="#upgrade" className="btn btn-primary">
                            <i className="fa-solid fa-arrow-up-right-dots" aria-hidden="true"></i> Upgrade
                        </a>
                    </div>
                </div>
                ...
                <div id="upgrade" className="plan-grid mt-4">
                    <div className="plan-card">
                        ...
                        <ul className="plan-list">
                            <li><i className="fa-solid fa-check"></i>10 applications / month</li>
                            <li><i className="fa-solid fa-check"></i>2 resume scans</li>
                    ...
                    <div className="plan-card active">
                        ...
                        <ul className="plan-list">
                            <li><i className="fa-solid fa-check"></i>40 applications</li>
                            <li><i className="fa-solid fa-check"></i>10 resume scans</li>
                            <li>
                                <i className="fa-solid fa-check"></i>AI rewrites + recruiter boost
                            </li>
                            <li>
                    ...
                    <div className="plan-card">
                        ...
                        <ul className="plan-list">
                            <li><i className="fa-solid fa-check"></i>Unlimited applications</li>
                            <li><i className="fa-solid fa-check"></i>Concierge career coach</li>
                            <li><i className="fa-solid fa-check"></i>Spotlight placement</li>
                            <li><i className="fa-solid fa-check"></i>Invite-only events</li>
                        </ul>
                        <button className="btn btn-outline-primary rounded-pill">
                            Upgrade to Elite
                        </button>
                ...
                <div className="list-card mt-4">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="/payment-history" className="btn btn-outline-primary btn-sm rounded-3">
                                View receipt
                            </a>
                        </li>
                    </ul>
