            ...
            <div className="dashboard-main">
                <div className="dashboard-page-header">
                    <div>
                        <h1>Saved Roles</h1>
                        <p>
                            Curate the opportunities you want to revisit, compare comp, and stay alerted on updates.
                        </p>
                    </div>

                    <div className="d-flex flex-wrap gap-2">
                        <a href="/job-alerts" className="btn btn-outline-primary">
                            <i className="fa-solid fa-bell" aria-hidden="true"></i> Manage alerts
                        </a>
                        <a href="/job-listing" className="btn btn-primary">
                            <i className="fa-solid fa-magnifying-glass" aria-hidden="true"></i> Find new jobs
                        </a>
                    </div>
                </div>
                        ...
                        <div className="col" key={index}>
                            <div className="saved-card">
                                ...
                                <div className="application-title">
                                    ...
                                    <p>{role.company} · {role.role}</p>
                                </div>

                                <div className="application-pill">
                                    <i className={`fa-solid ${role.pillIcon}`} aria-hidden="true"></i>
                                    {role.pillText}
                                </div>
                                ...
                                <div className="application-footer">
                                    <div className="application-meta">
                                        <div className="meta-avatar">
                                            <img src={`/assets/images/employers/${role.logo}`} alt={role.company} />
                                        </div>
                                        <div>
                                    ...
                                    <button className={`btn ${role.actionClass} btn-sm rounded-pill`} aria-label={role.actionText}>
                                        {role.actionIcon && (
                                            <i className={`fa-solid ${role.actionIcon}`} aria-hidden="true"></i>
                                        )}
                                        {role.actionText}
                                    </button>
                                </div>
                    ...
                    <ul>
                        {collections.map((collection, index) => (
                            <li key={index}>
                                ...
                                <a href="#" className={`btn ${collection.actionClass} btn-sm rounded-3`}>
