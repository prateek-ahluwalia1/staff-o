...
function Hero() {
  ...
  <div className="hero-right">
    <div className="hero-photo">
      <img className="guard-silhouette" src="https://images.pexels.com/photos/13051291/pexels-photo-13051291.jpeg?_gl=1*1v72xyx*_ga*MTUwMzU1MTc3OS4xNzc5MTA2OTg4*_ga_8JE65Q40S6*czE3NzkxMDY5ODgkbzEkZzEkdDE3NzkxMDcwNzckajU5JGwwJGgw" alt="Security guard in uniform" />
    </div>
